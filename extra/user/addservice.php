...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if(isset($nameErr)&&isset($descriptionErr)&&isset($phoneErr)){
      $query = "Insert into CommunityList values(NULL,'".$name."','".$address."','".$description."','".$phone."',default,'".$_SESSION[email]."','".$_SESSION[password]."',Eugene,'".$_POST['classify']."');";
