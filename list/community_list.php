...
$query = "Select Co.Community_id, Co.Name, Co.Date_public from CommunityList Co join Community C on (Co.Community_City_City_name = C.City_City_name) and (Co.Community_Community_name = C.Community_name) where Co.Community_City_City_name = '".$_SESSION['city']."' and C.Classfication = 'Community' and Co.Community_Community_name =";
?>
...
<li><a href = "community_list_content.php?id=<?php echo $row['Community_id'];?>"><?php echo $row['Name']."(".$row['Date_public'].")";?></a>||<a onclick = "return confirm('Are you sure to delete this advertisement?')" href ="delete_com.php?id=<?php echo $row['Community_id'];?>">Delete</a></li>
    ...
    <center><a href = "addcommunity.php">Add</a></center>
